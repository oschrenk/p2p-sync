 ...
 * 
 */
public class UpdatePullTask extends GenericTask {

	private static Logger logger = Logger.getLogger(UpdatePullTask.class);
	 ...
	 * @see GenericTask
	 */
	public UpdatePullTask(LocalIndex localIndex, RemoteIndex remoteIndex,
			Path path) {
